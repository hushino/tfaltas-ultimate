...
<div contenteditable = "true" style = "text-align:justify;" id = "exa">Clorinda, ___ de <?php echo $fecha_mesyanio; ?>.- Por recibido. Conforme lo prescripto por el art. 18 de la Ordenanza 625/2014 y al Acta N&#176; 01/2015, asignase el expediente a la Secretar&iacute;a del Dr. <?php echo $row_causa['SECRE']; ?>. Por Secretar&iacute;a verif&iacute;quese los antecedentes que pudiera registrar <strong><?php echo $row_causa['NOMBRES']; ?> <?php echo $row_causa['APELLIDOS']; ?></strong>,  D.N.I. N&#176; <strong><?php echo $row_causa['DNI']; ?></strong> y d&eacute;jese constancia. Cumplido que se encuentra el t&eacute;rmino de citaci&oacute;n por el que fuera emplazado, informe el Sr. Secretario sobre la presentaci&oacute;n de descargo. Fecho sigan la actuaciones seg&uacute;n su estado. -
...
<?php if ($totalRows_antec2 > 1) { // Show if recordset not empty ?><br><br>Antecedentes Posteriores a JUN/2015:<?php } // Show if recordset not empty ?>
              <?php do { ?><?php if ($row_antec2['INFACTA'] <> $row_causa['INFACTA']) {echo $row_antec2['descrip'];} ?><?php } while ($row_antec2 = mysql_fetch_assoc($antec2)); ?><?php if ($row_antec2['INFACTA'] <> $row_causa['INFACTA']) { echo '<br>'; } ?> As&iacute; mismo se deja constancia que el presunto infractor no ha efectuado descargo alguno, y se encuentra vencido el plazo para hacerlo. Es todo cuanto puedo informar. Paso las actuaciones para el dictado de resoluci&oacute;n. -
