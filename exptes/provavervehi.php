...
<title>TFaltas - averiguar vehiculos</title>
...
<div contenteditable = "true" style = "text-align:justify;" id = "exa">Clorinda, ___ de <?php echo $fecha_mesyanio; ?>.- Por recibido. Conforme lo prescripto por el art. 18 de la Ordenanza 625/2014 y al Acta N&#176; 01/2015, asignase el expediente a la Secretar&iacute;a del Dr. <?php echo $row_causa['SECRE']; ?>. Previo a disponer lo que en derecho corresponda, por Secretar&iacute;a verif&iacute;quese y d&eacute;jese constancia de la titularidad del veh&iacute;culo dominio <strong><?php echo $row_causa['INFAUTOPAT']; ?></strong>. -</div>
