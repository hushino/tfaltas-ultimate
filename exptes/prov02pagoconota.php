...
<title>TFaltas - provehido Pago con Nota</title>
<link rel="stylesheet" type="text/css" href="../css/imprimir.css" media="print" />
</head>

<body style = "font-family: Calibri; font-size: 11pt; line-height: 175%;">
<div contenteditable = "true" style = "text-align:justify;height: 20cm; display: -webkit-box;
  line-height: 175%; -webkit-line-clamp: 30; -webkit-box-orient: vertical; max-height: 20cm" id = "exa">Clorinda, ___ de <?php echo $fecha_mesyanio; ?>.- Por recibida Acta de Infracci&oacute;n. Conforme lo prescripto por el art. 18 de la Ordenanza 625/2014 y al Acta N&#176; 01/2015, asignase el expediente a la Secretar&iacute;a del Dr. <?php echo $row_causa['SECRE']; ?>. Y atento la comparecencia de <strong><?php echo $row_causa['NOMBRES']; ?> <?php echo $row_causa['APELLIDOS']; ?></strong>,  D.N.I. N&#176; <strong><?php echo $row_causa['DNI']; ?></strong>, previo recibirse su pago por Secretaria verif&iacute;quense sus antecedentes. Y em&iacute;tase Nota de Pago. -
<br><br><br><br><br><br>
...
<div contenteditable = "true" style = "text-align:justify; float: left; display: -webkit-box;
  line-height: 175%; -webkit-line-clamp: 30; -webkit-box-orient: vertical; " id = "exa2">Clorinda, ___ de <?php echo $fecha_mesyanio; ?>. - Por recibida Nota de Pago debidamente intervenida por la Direcci&oacute;n de Rentas de la Municipalidad. Verif&iacute;quese el mismo y pasen las actuaciones para el dictado de resoluci&oacute;n. -
