...
//  $armado = "SELECT LPAD(ID,6,'0')," . $_POST['depdestino'] . ", now(),'" . $_SESSION['MM_Username'] . "' FROM causas WHERE '" . $_POST['listacau'] . "' LIKE CONCAT('%',LPAD(ID,6,'0'),'%')";
  $insertSQL = sprintf("UPDATE causas SET SPECLIST = 'S' WHERE ID = %s",$armado);
//$insertSQL2 = "";
echo $insertSQL;
...
<legend class="ui-widget-header ui-corner-all ui-state-highlight" style="padding:1px 10px;" id="grupoContacto">Lista de resoluciones conjuntas</legend>
<table width="400" border="0" cellspacing="1" class="formulario" style="width: 95%; text-align: right;">
	...
	<tr>
	  ...
	  <td style="width: 200px; text-align: right;">
        ...
        <tr>
          <td colspan="2" align="left" style="width:auto;">Lista<br>
