...
$infra_listadeexptes = "";
if (isset($_GET['inf'])) {
  //http://localhost/tfaltas/site.php?inf=00115
      ...
      <tbody>
        ...
        <tr class="lineas1"
          ...
          <td rowspan="2" style="width: 150px"><span
              style="width: 300px"><?php echo $row_listadeexptes['INFOBSER']; ?></span><br><?php if (isset($row_listadeexptes['RES_DEFININRO'])) { ?><br>Resoluci&oacute;n:
