...
<table width="100%" border="1">
  <tbody>
    ...
    <tr>
      ...
      <br><input name="oblada" type="checkbox" id="oblada" title="Si el Presentante no es el mismo Imputado" value="N" onchange="javascript:showContent()">
      ...
      <div id="contoblada" style="display: none; text-align: left; ">
        ...
        D.N.I.:<input type="text" name="dni" id="dni"><br>
        Fecha de Nacimiento:<input type="date" name="fenacim" id="fenacim">
    ...
    <tr>
      ...
      <td>
        Telefono de contacto: <input name="telcontac" type="text" id="telcontac" style="width:150px;" title="Telefono de Contacto" /><br>
        Domicilio Real: <input type="text" name="domreal" placeholder="Cargar Domicilio Real" size="50" id="domreal">
        <input name="domigual" type="checkbox" id="domigual" title="Si el Domicilio es el mismo que el Constituido" value="S" onchange="javascript:putContent()"><br>Domicilio Constituido: <input type="text" size="50" name="domconst" id="domconst" placeholder="Cargar Domicilio Constituido" required /> </td>
    </tr>
    <tr>
      <td>
      </td>
    ...
    <tr>
      ...
      <td>
        Fecha de Presentacion: <input type="date" name="fechax" id="fechax" required> - Hora: <input type="time" name="horax" id="horax" title="La hora es necesaria"  required></td>
    </tr>
    <tr>
      <td></td>
      <td>
    ...
    <tr>
      <td></td>
      <td>
        <textarea name="escconten" id="escconten" placeholder="Resumen del Contenido del Escrito" rows="5" cols="60"></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
