...
<table width="400" border="0" cellspacing="1" class="formulario" style="width: 95%; text-align: right;">
	...
	<tr id="filaActaInfr">
	  ...
	  <td style="width: 200px;"><span style="width:100px;">Acta de Inf. Nº</span>	    <input name="infacta" type="text" required="required" id="infacta" style="width:100px;" tabindex="1" autocomplete="off" value="<?php echo $row_cauresol['INFACTA']; ?>" readonly onFocusOut="javascript:verificar()" /><div id="final"></div></td></tr>
	<tr id="filaActaInfr">
...
<legend class="ui-widget-header ui-corner-all ui-state-highlight" style="padding:1px 10px;" id="grupoDomicilio">Datos Para el Registro de Infractores</legend><table class="formulario" style="width: 45%; text-align: justify;">
	...
	<tr>
	  ...
	  <td><p>
	    <label>
	      <input type="radio" name="RadioGroup1" value="Leve" id="RadioGroup1_0">
	      Leve</label>
	    
	    <label>
	      <input type="radio" name="RadioGroup1" value="Grave" id="RadioGroup1_1">
	      Grave</label>
	    <br>
	    </p></td>
	  </tr>
