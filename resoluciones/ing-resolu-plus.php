...
<head>
  ...
  $(document).ready(function() {
    $("#infartx").tokenInput("/tfaltas/consultas/listadeinfracciones.php", {
      prePopulate: < ? php
      echo "[";do {
        echo "{\"id\": \"".$row_multas['IDINF'].
        "\", \"name\": \"".$row_multas['names'].
        "\"}, ";
      ...
      <form name="formulario" id="formulario" action="<?php echo $editFormAction; ?>" method="POST">
        ...
        <fieldset class="ui-widget ui-widget-content ui-corner-all"
          ...
          <legend class="ui-widget-header ui-corner-all ui-state-highlight" style="padding:1px 10px;"
            id="grupoContacto">Datos de la Falta Cometida</legend>
          <table width="400" border="0" cellspacing="1" class="formulario" style="width: 95%; text-align: right;">
            <tr>
              ...
              <td align="left" style="width: 200px;"><span style="width: 200px; text-align: right;">
                  <input name="deporig" id="deporig" type="text" required="required" style="width:100px;" tabindex="1"
                    autocomplete="off" value="<?php echo $row_cauresol['DEPORIG']; ?>" readonly />
                </span></td>
            </tr>
            <tr id="filaActaInfr">
              <td style="width: 200px; text-align: right;">
                ...
                <input name="IDx" type="text" required="required" id="IDxx" style="width:100px;" tabindex="1"
                  autocomplete="off" value="<?php echo $row_cauresol['ID']; ?>" readonly /></td>
              <td style="width: 200px;"><span style="width:100px;">Acta de Inf. Nº</span> <input name="infacta"
                  type="text" required="required" id="infacta" style="width:100px;" tabindex="1" autocomplete="off"
                  value="<?php echo $row_cauresol['INFACTA']; ?>" readonly onFocusOut="javascript:verificar()" />
                <div id="final"></div>
              </td>
            </tr>
            <tr id="filaActaInfr">
              <td style="width: 200px; text-align: right;">Fecha </td>
              <td style="width: 200px; text-align: right;"><b>Hora</b></td>
            </tr>
            <tr>
        ...
        <div style="">
          <fieldset class="ui-widget ui-widget-content ui-corner-all"
            ...
            <legend class="ui-widget-header ui-corner-all ui-state-highlight" style="padding:1px 10px;"
              id="grupoApellidoNombre">Datos de la Resolucion</legend>

            <fieldset class="ui-widget ui-widget-content ui-corner-all"
              style="width: 200px; margin-left: auto; margin-right: auto;">
              <legend class="ui-widget-header ui-corner-all ui-state-highlight" style="padding:1px 10px;"
                id="grupoDomicilio">Datos Pde la Resolucion a cargar</legend>
              <table class="formulario" style="width: 45%; text-align: justify;">
                <tr>
                  <th style="width:40px;" id="tituloApellido3">Nro. de resolución</th>
                  <td><input name="resolnro" type="text" autofocus required id="resolnro" style="width:205px;"
                      tabindex="9" autocomplete="off" /></td>
                </tr>
                <tr>
                  <th style="width:40px;" id="tituloApellido2">Fecha</th>
                  <td><input name="resolfecha" type="date" required id="resolfecha" style="width:205px;" tabindex="9"
                ...
                <tr>
                  ...
                  <td><input name="apellidos" type="text" id="apellido" style="width:205px;" tabindex="9"
                      autocomplete="off" value="<?php echo $row_cauresol['APELLIDOS']; ?>" /></td>
                </tr>
                <tr>
                  <th style="width:40px;">Nombres</th>
                  <td><input name="nombres" type="text" id="nombres" style="width:205px;" tabindex="10"
                      autocomplete="off" value="<?php echo $row_cauresol['NOMBRES']; ?>" /></td>
                </tr>
                <tr>
                  <th style="width:40px;">D.N.I.</th>
                  <td><input name="dni" type="text" id="dni" style="width:85px;" tabindex="11" autocomplete="off"
                      value="<?php echo $row_cauresol['DNI']; ?>" /></td>
                </tr>
                <tr>
                  <th style="width:50px;">Doc.Nac.</th>
                  <td><input name="dninac" type="text" id="dninac" style="width: 50px; float: left;" pattern="[A-Z]{3}"
                      tabindex="11" autocomplete="off" value="<?php echo $row_cauresol['DNINAC']; ?>" /></td>
                </tr>
              </table>
            </fieldset>
          </fieldset>
